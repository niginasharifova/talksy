...
final class ChatViewController: MessagesViewController {
    ...
    private func presentInputActionSheet() {
        ...
        actionSheet.addAction(UIAlertAction(title: "Contact", style: .default, handler: { [weak self]  _ in
...
extension ChatViewController: CNContactPickerDelegate {
    func contactPicker(_ picker: CNContactPickerViewController, didSelect contact: CNContact) {
        ...
        let contactItem = ContactModel(displayName: contactName,
        ...
        let message = Message(sender: selfSender,
                              messageId: messageId,
                              sentDate: Date(),
                              kind: .contact(contactItem))

        DataBaseManager.shared.sendMessage(to: conversationId, otherUserEmail: otherUserEmail, name: name, newMessage: message, completion: { success in
            if success {
                print("sent contact message")
            } else {
