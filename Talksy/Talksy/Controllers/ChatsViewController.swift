...
final class ChatsViewController: UIViewController {
    ...
    private let tableView: UITableView = {
        ...
        table.register(ChatTableViewCell.self,
                       forCellReuseIdentifier: ChatTableViewCell.nameOfClass)
        return table
    }()

    private let noConversationsLabel: UILabel = {
        let label = UILabel()
        label.text = "У вас пока нет сообщений"
...
extension ChatsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: ChatTableViewCell.nameOfClass,
